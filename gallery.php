...
<body onkeydown="activite_detectee = true;" onmousemove="activite_detectee = true;"
    onscroll="activite_detectee = true;">
    <?php
    $protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http';
    $host = $_SERVER['HTTP_HOST'];
    $path = $_SERVER['REQUEST_URI'];
    $currentUrl = $protocol . '://' . $host . $path;
    $currentUrl = substr($currentUrl, 0, -11);
    ?>
    <section class="container">
        ...
        <div class="mascotte-container">
            ...
            <div class="mascotte" id="screenMascotte">
                ...
                <img id="accessories" class="choice descend"
                    src="images/Accessoires/Gallery/<?= $mascottes[0]['lien_sport'] ?>">
            ...
            <div class="grille" onscroll="activite_detectee = true;">
                ...
                <?php foreach ($mascottes as $mascotte) { ?>
                    <div class="mascotte-gallery" id="<?= $mascotte['id'] ?>">
                        ...
                        <img class="descend" id="accessories"
                            src="images/Accessoires/Gallery/<?= $mascotte['lien_sport'] ?>">
                    </div>
                    ...
                    <div class="popUpQrcode mascotte<?= $mascotte['id'] ?>">
                        <div class="contentQRcode">
                            <a href="qrcode.php?id=<?= $mascotte['id'] ?>">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo $currentUrl; ?>qrcode.php?id=<?= $mascotte['id'] ?>/&size=150x150"
                                    alt="" title="" /></a>
